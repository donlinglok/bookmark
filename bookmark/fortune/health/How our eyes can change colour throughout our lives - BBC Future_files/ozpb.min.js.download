...
console.log('Ozone INCLUDE JS PAGE: 20220606 17:20');
...
var ozoneWrapper = {
    ...
    tcfapiLocator: {
        ...
        timeoutMs: 600, /* only try to discover the __ticapi function for a max of this ms */
        timeStarted: null,
...
// NEW: 20220624 - call the adserver
    ...
    adunitNameRegexMatches: {
        ...
        'future': /^\/future/,
        'sci_env': /^\/science_and_environment/,
        ...
        window.__uspapi('uspPing', 1, function(obj, status) {
            ...
            if(obj.cmpLoaded) {
                if (status && obj.mode.includes('USP') && obj.jurisdiction.includes(obj.location.toUpperCase())) {
                    ozoneLog('USP is active for this user');
                    ozoneWrapper.cmpUsp = true;
                } else {
                    ozoneLog('USP is NOT active for this user');
                    ozoneWrapper.cmpUsp = false;
                }
            } else {
